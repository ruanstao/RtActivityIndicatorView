...
@interface RtRefreshHeader()<RtActivityIndicatorViewDelegate>

@property (weak, nonatomic) RtActivityIndicatorView *indicatorView;
@end


@implementation RtRefreshHeader
...
- (void)prepare
{
    ...
    // 添加label
    RtActivityIndicatorView *indicatorView = [[RtActivityIndicatorView alloc] init];
...
- (void)placeSubviews
{
    ...
    self.indicatorView.center =  CGPointMake(self.mj_w *0.5 - 45 , self.mj_h * 0.5 - 10);
